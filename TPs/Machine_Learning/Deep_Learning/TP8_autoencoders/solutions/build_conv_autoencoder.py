def build_conv_autoencoder():
    ...
    conv_encoder.add(Conv2D(16, (3,3) , activation='relu', input_shape=(28,28,1) , padding='same' ))
    ...
    conv_decoder.add(Conv2D(8, (3, 3), activation='relu', input_shape = (4, 4, 8), padding='same'))
